	...
	<div class="container-fluid">
		<form method="post">
			<div class="p-4 mx-auto mr-4 shadow rounded" style="margin-top: 50px;width:100%;max-width: 340px;">
				...
				<h3>Add User</h3>
				<input value="<?=get_var('firstname')?>" class="my-2 form-control" type="firstname" name="firstname" placeholder="Frist Name" >
				<input value="<?=get_var('lastname')?>" class="my-2 form-control" type="lastname" name="lastname" placeholder="Last Name" >
